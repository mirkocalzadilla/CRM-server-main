"""Entrada de Alembic con soporte async (asyncpg) y autogenerate."""
...
# Importa los modelos para que estén registrados en Base.metadata
from server.modules.agent.domain import models as agent_models  # noqa: F401
