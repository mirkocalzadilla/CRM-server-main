"""core: initial schema (tenants, users, tenant_users)
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            postgresql.ENUM("owner", "admin", "member", name="tenant_user_role", create_type=False),
            nullable=False,
...
def downgrade() -> None:
    ...
    tenant_user_role = postgresql.ENUM(
        "owner", "admin", "member", name="tenant_user_role", create_type=False
    )
    tenant_user_role.drop(op.get_bind(), checkfirst=True)
